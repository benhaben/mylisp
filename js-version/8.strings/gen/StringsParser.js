...
var ruleNames =  [ "lispy", "expr", "sexpr", "qexpr", "comment", "string" ];
...
StringsParser.RULE_comment = 4;
StringsParser.RULE_string = 5;
...
StringsParser.prototype.lispy = function() {
    ...
    try {
        ...
        while((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << StringsParser.NUMBER) | (1 << StringsParser.COMMENT) | (1 << StringsParser.STRING) | (1 << StringsParser.SYMBOL) | (1 << StringsParser.LP) | (1 << StringsParser.LB))) !== 0)) {
            this.state = 12;
            this.expr();
            this.state = 17;
            this._errHandler.sync(this);
...
ExprContext.prototype.comment = function() {
...
function CommentContext(parser, parent, invokingState) {
	...
	antlr4.ParserRuleContext.call(this, parent, invokingState);
    this.parser = parser;
    this.ruleIndex = StringsParser.RULE_comment;
    return this;
}
...
CommentContext.prototype.COMMENT = function() {
    return this.getToken(StringsParser.COMMENT, 0);
};




StringsParser.CommentContext = CommentContext;

StringsParser.prototype.comment = function() {

    var localctx = new CommentContext(this, this._ctx, this.state);
    this.enterRule(localctx, 8, StringsParser.RULE_comment);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 44;
        this.match(StringsParser.COMMENT);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
StringsParser.prototype.string = function() {
    ...
    this.enterRule(localctx, 10, StringsParser.RULE_string);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 46;
